...
export function VendingMachineSection({
  ...
  return (
    ...
    >
      <div className="relative p-5 sm:p-8 md:p-12 rounded-3xl border border-white/15 bg-[#0a0a0a] shadow-[0_0_60px_rgba(0,0,0,0.85)] hover:border-cyan-500/40 transition-colors duration-300 flex flex-col gap-6 sm:gap-8 overflow-hidden group transform-gpu">
        ...
        {milestone.accolades?.[0] && (
          <div className="relative z-10 p-4 sm:p-5 md:p-6 rounded-2xl bg-white/[0.02] border border-white/10 flex items-start gap-3 sm:gap-4">
